...
//		}
		...
		Estante estante = new Estante(prateleira1, prateleira2);

		for (int i=0;i<estante.getPrateleiras().length;i++) {
			System.out.println("Prateleira " + (i+1));
			
			// fazer um for para mostra os titulos dos livros de cada prateleira
		  //  estante.getPrateleiras()[i].getLivros()
		}
	}
}
